...
class inventoryManagement{
    ...
    fillRice(){
        ...
        let price=readline.questionFloat("Enter the price for the rice in per/Kg : ");
    ...
    fillWheat(){
        ...
        let price=readline.questionFloat("Enter the price for the Wheat in per/Kg : ");
        let weight=readline.questionFloat("Enter the weight : ");
    ...
    fillPulse(){
        ...
        let price=readline.questionFloat("Enter the price for the Pulse in per/Kg : ");
        let weight=readline.questionFloat("Enter the weight : ");
    ...
    inventoryObject(){
        ...
        console.log(this.inventories.pulse);
        console.log('-------WHEATS OBJECT-------');
        console.log(this.inventories.wheat);
    }
}
module.exports={
    inventoryManagement,rice,wheat,pulse
}